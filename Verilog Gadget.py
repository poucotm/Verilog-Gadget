...
##  class getHeaderText  _____________________

def getHeaderText(view):
    if not check_extension(view.file_name(), view.name()):
        return
...
##  class VerilogGadgetModuleInstCommand  _
...
##  class VerilogGadgetChangeModifyTimeCommand  _____________________
